...
- [ ] The response remains compatibility-only and adds no likelihood, power, critical-effect,
      selection, Type S/M, precision, clinical-threshold, or decision-support behavior.
